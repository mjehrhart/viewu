...
struct ViewSettings: View {
    ...
    // NEW: store the numeric rawValue of LogLevel in AppStorage
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Picker(
                            ...
                            selection: Binding<LogLevel>(
                                get: {
                                    LogLevel(rawValue: logLevelRaw) ?? .debug
                                },
                                set: { newValue in
...
//    @AppStorage("frigateVersion") private var frigateVersion: String = "0.0-0"
//    
//    @AppStorage("log_level") private var logLevelRaw: String = LogLevel.debug.rawValue Cannot convert value of type 'Int' to expected argument type 'String'
//
//    @StateObject var nts = NotificationTemplateString.shared()
//    
//    let widthMultiplier:CGFloat = 2/5.8   // kept; no longer used for fixed widths
